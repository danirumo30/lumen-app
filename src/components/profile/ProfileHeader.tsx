          ...
          <div className="flex items-end gap-3 sm:gap-6 w-full">
            ...
            <div className="relative flex-shrink-0">
              ...
              {!profile.avatarUrl && (
                <div className="absolute inset-0 flex items-center justify-center rounded-full">
                  <span className="text-2xl sm:text-3xl md:text-4xl font-semibold text-white drop-shadow-lg">
            ...
            <div className="flex-1 text-white min-w-0">
              ...
              <div className="flex gap-3 sm:gap-6 mt-1">
                ...
                >
                  <span className="font-bold text-sm sm:text-lg group-hover:scale-110 transition-transform">
                    {followersCount}
                  </span>
                  <span className="text-xs text-zinc-300 group-hover:text-white">seguidores</span>
                </button>
                <button
                ...
                >
                  ...
                  <span className="text-xs text-zinc-300 group-hover:text-white">siguiendo</span>
                </button>
              </div>
            </div>
            ...
            <div className="flex gap-2 sm:gap-3 flex-shrink-0">
              ...
              {!isOwnProfile && (
                <button
                  ...
                  className={`px-3 sm:px-6 py-1.5 sm:py-2 rounded-xl font-medium text-xs sm:text-sm transition-all ${
                    isFollowing
